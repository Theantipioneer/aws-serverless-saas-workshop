...
# echo Y | sam sync --stack-name stack-pooled --code --resource-id UploadFunction --resource-id AnalyseExpenseFunction -u --template tenant-template.yaml
# echo Y | sam sync --stack-name stack-pooled --code --resource-id GetExpenseAnalysisFunction --resource-id CreateDocumentFunction -u --template tenant-template.yaml
...
# echo Y | sam sync --stack-name acumen-saas --code --resource-id LambdaFunctions/UpdateTenantFunction -u --template shared-template.yaml
