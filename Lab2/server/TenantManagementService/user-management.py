...
table_tenant_user_map = dynamodb.Table("Acumen-TenantUserMapping")
...
def create_user(event, context):
    ...
    response_mapping = user_mgmt.create_user_tenant_mapping(
        user_details["userName"], tenant_id
    )
...
def disable_user(event, context):
    ...
    response = client.admin_disable_user(Username=user_name, UserPoolId=user_pool_id)
